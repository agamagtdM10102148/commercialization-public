...
#### [Install Windows from a DVD](desktop/boot-from-a-dvd.md)
...
###### [Deploy .NET Framework 3.5 by using DISM](desktop/deploy-net-framework-35-by-using-deployment-image-servicing-and-management--dism.md)
...
###### [Change the Windows image to a higher edition](desktop/change-the-windows-image-to-a-higher-edition-using-dism.md)
...
##### [Available languages](desktop/available-language-packs-for-windows.md)
##### [Language and region Features on Demand](desktop/features-on-demand-language-fod.md)
#### [International settings](desktop/configure-international-settings-in-windows.md)
##### [Default input profiles (input locales)](desktop/default-input-locales-for-windows-language-packs.md)
##### [Default time zones](desktop/default-time-zones.md)
##### [Keyboard identifiers and input method editors](desktop/windows-language-pack-default-values.md)
...
##### [Frequently-asked questions (FAQ)](desktop/pbr-faq.md)
##### [Validation scenarios](desktop/pbr-validation.md)
...
##### [Command-line options](desktop/deployment-image-servicing-and-management--dism--command-line-options.md)
###### [Image management (.wim, .ffu, .vhd)](desktop/dism-image-management-command-line-options-s14.md)
###### [Global options for command-line syntax](desktop/dism-global-options-for-command-line-syntax.md)
###### [Operating system packages (.cab or .msu)](desktop/dism-operating-system-package-servicing-command-line-options.md)
###### [Provisioning packages (.ppkg)](desktop/dism-provisioning-package-command-line-options.md)
###### [App packages (.appx or .appxbundle)](desktop/dism-app-package--appx-or-appxbundle--servicing-command-line-options.md)
###### [App patches (.msp)](desktop/dism-application-servicing-command-line-options.md)
###### [Default application associations](desktop/dism-default-application-association-servicing-command-line-options.md)
###### [Languages and international](desktop/dism-languages-and-international-servicing-command-line-options.md)
###### [Capabilities packages](desktop/dism-capabilities-package-servicing-command-line-options.md)
###### [Windows editions](desktop/dism-windows-edition-servicing-command-line-options.md)
###### [Drivers (.inf)](desktop/dism-driver-servicing-command-line-options-s14.md)
###### [Unattended answer files (unattend.xml)](desktop/dism-unattended-servicing-command-line-options.md)
###### [Windows PE](desktop/dism-windows-pe-servicing-command-line-options.md)
###### [Operating system uninstall](desktop\dism-uninstallos-command-line-options.md)
##### [DISM reference](desktop/dism-reference--deployment-image-servicing-and-management.md)
###### [Configuration list and WimScript.ini files](desktop/dism-configuration-list-and-wimscriptini-files-winnext.md)
###### [Best practices](desktop/deployment-image-servicing-and-management--dism--best-practices.md)
###### [Supported platforms](desktop/dism-supported-platforms.md)
...
##### [Supported platforms and cross-platform deployments](desktop/windows-setup-supported-platforms-and-cross-platform-deployments.md)
##### [Add languages to Windows Setup](desktop/add-multilingual-support-to-windows-setup.md)
##### [Scenarios and best practices](desktop/windows-setup-scenarios-and-best-practices.md)
##### [Windows Setup command-line options](desktop/windows-setup-command-line-options.md)
##### [States](desktop/windows-setup-states.md)
##### [Edition configuration and product ID files (EI.cfg and PID.txt)](desktop/windows-setup-edition-configuration-and-product-id-files--eicfg-and-pidtxt.md)
##### [Log files and event logs](desktop/windows-setup-log-files-and-event-logs.md)
##### [Configuration passes](desktop/windows-setup-configuration-passes.md)
