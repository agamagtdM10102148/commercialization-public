...
###### [Image management](desktop/dism-image-management-command-line-options-s14.md)
###### [Global options for command-line syntax](desktop/dism-global-options-for-command-line-syntax.md)
###### [Operating system package (.cab or .msu) servicing](desktop/dism-operating-system-package-servicing-command-line-options.md)
###### [Provisioning package (.ppkg)](desktop/dism-provisioning-package-command-line-options.md)
###### [App Package (.appx or .appxbundle) servicing](desktop/dism-app-package--appx-or-appxbundle--servicing-command-line-options.md)
###### [Application servicing (.msp)](desktop/dism-application-servicing-command-line-options.md)
###### [Default application association servicing](desktop/dism-default-application-association-servicing-command-line-options.md)
###### [Languages and international servicing](desktop/dism-languages-and-international-servicing-command-line-options.md)
###### [Capabilities package servicing](desktop/dism-capabilities-package-servicing-command-line-options.md)
###### [Windows edition-servicing](desktop/dism-windows-edition-servicing-command-line-options.md)
###### [Driver servicing (.inf)](desktop/dism-driver-servicing-command-line-options-s14.md)
###### [Unattended servicing](desktop/dism-unattended-servicing-command-line-options.md)
###### [Windows PE servicing](desktop/dism-windows-pe-servicing-command-line-options.md)
